...
if __name__ == '__main__':
    ...
    for sid in stock_dict.keys():
        data = ts.get_k_data(sid, ktype="W")
        ...
        if ema30[-1] is np.nan:
            print "new stock, just ignore"
            continue
        
        print ema10[-1], ema20[-1], ema30[-1], ema60[-1]
        
        if (ema5[-1] > ema10[-1]) and (ema10[-1] > ema20[-1]) and (ema20[-1] > ema30[-1]):# and (ema30[-1] > ema60[-1]):
            print "start to draw charts"
            fname = "D:\\quant\\" + sid + "-W-K-Max30W" + ".png"
            
            draw_stock_with_multi_periods(sid, ("W", "D"), fname)
            
            lst_choosen.append(sid)
